...
#!/usr/bin/python
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>BEGIN SETUP>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#Importing phue phillips lights python wrapper from https://github.com/studioimaginaire/phue
...
#Library for WS261X addressable LEDs from https://github.com/jgarff/rpi_ws281x
...
#Random Library
import random
#assign the phillips bridge to value b
b = Bridge('10.0.0.79')
#Connect to bridge
b.connect
...
#create variable for Neopixels to be called
